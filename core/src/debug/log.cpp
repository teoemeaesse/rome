...
namespace iodine::core {
    ...
    void assertFail(const char* expression, const char* file, int line, const char* function) {
        ...
        logMessage(LogLevel::Fatal, "Assertion failed: %s in file %s, line %d, function \"%s\"", expression, file, line, function);
        abort();
    }
    ...
    void assertFail(const char* expression, const char* message, const char* file, int line, const char* function) {
        ...
        logMessage(LogLevel::Fatal, "Assertion failed: %s\n Message: \"%s\" in file %s, line %d, function \"%s\"", expression, message, file, line,
                   function);
        abort();
    }
}  // namespace iodine::core
